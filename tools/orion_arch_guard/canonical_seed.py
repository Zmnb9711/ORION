...
GOLDEN_COMPONENTS: tuple[CanonicalRecord, ...] = (
    ...
    _golden("GC06", "Core fact binding", ("WORLD_MODEL", "NATURAL_INFORMATIONAL_PRESENTATION"), boundary="Core owns exact informational facts", sources=("D45", "D72", "D75", "27e94bdbf843a3f1895db2756eed49e42fe07989"), evidence=("AIRCRAFT_FA18_FIELD", "AIRCRAFT_F5_FIELD")),
    _golden("GC07", "Placeholder and semantic fact validation", ("NATURAL_INFORMATIONAL_PRESENTATION",), boundary="Core validates provider output against bound and permitted contextual facts", sources=("D72", "D75", "27e94bdbf843a3f1895db2756eed49e42fe07989", "77d562d4"), evidence=("AIRCRAFT_FA18_FIELD", "AIRCRAFT_F5_FIELD")),
...
HISTORICAL_RECONNECT_ITEMS: tuple[CanonicalRecord, ...] = (
    CanonicalRecord(
        ...
        status="RECONNECTED_ADAPTED_NON_DEFAULT",
        ...
        proof_level="HISTORICAL_FIELD_PROVEN_CURRENT_AUTOMATED_PROVEN",
        recommended_action="CONTROLLED_C4_FIELD_PROOF",
        priority="CURRENT_NON_DEFAULT_CANDIDATE",
        source_refs=("D40", "D71", "D72", "D74", "D75", "f64d8424d0cfd00543d18a2f0c1fa5a6f81b6b05", "77d562d4", "f2df3713"),
        evidence_refs=("IPB-20260903-171624",),
        metadata={
            "disposition": "KEEP",
            "production_default": False,
            "benchmark_verdict": "BENCHMARK_NO_GO",
            "benchmark_verdict_scope": "HISTORICAL_IPB_20260903_171624_ONLY",
            "current_integration_status": "C3_AUTOMATED_PROVEN_NON_DEFAULT",
            "current_semantic_policy": "D75_CURRENT_CLARIFIED",
            ...
            "promotion_gate": "controlled C4 DCS/SRS field proof; production default remains Qwen",
        },
    ),
    CanonicalRecord(
        record_id="HR02",
...
_STAGES: tuple[tuple[str, str, str], ...] = (
    ("C0", "CANONICAL ORION BASELINE ESTABLISHED", "COMPLETE"),
    ("C1", "REALTIME INFORMATIONAL PRESENTER RELIABILITY CORRECTION", "COMPLETE"),
    ("C2", "REALTIME INFORMATIONAL PRESENTER ISOLATED REBENCHMARK", "COMPLETE"),
    ("C3", "BOUNDED NON-DEFAULT PRESENTATION INTEGRATION", "COMPLETE"),
    ("C4", "CONTROLLED INFORMATIONAL DCS/SRS FIELD PROOF", "APPROVED_NEXT_STEP"),
...
CANONICAL_ROADMAP_STAGES: tuple[CanonicalRecord, ...] = tuple(
    CanonicalRecord(
        ...
        metadata={
            ...
            "current_position": stage_id == "C3",
            "field_proof_required": stage_id == "C4",
        },
    )
