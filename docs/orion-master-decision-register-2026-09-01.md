...
| D75 | 2026-09-03 | Informational semantic validation | Normal informational responses remain freely and naturally AI-formulated; Core owns `SemanticResponse`, factual truth, availability, provenance and freshness, while AI may select additional relevant informational facts only from a bounded Core/WorldModel context where every fact is known, authoritative, fresh and permitted; the error is an unsupported assertion, not the mere presence of a second fact; Core validates all final-response factual assertions without treating arbitrary RU/EN grammar or punctuation as the primary safety mechanism; protected operational wording remains Core-owned | User | Explicit, clarified | C1-HR01 structural-only safety failure and direct user decisions | Non-default bounded-context semantic-validation candidate over HR01/IA-1/Core binding | APPROVED / CURRENT | Conversational minimalism; unsupported assertions; stale/unknown facts as known; grammar-primary natural-response validation; AI fact authority | User tasks, `AG-20260903-215347-b2405b74-d5af18e-r2`, `AG-20260903-223036-3bc60aa0-77d562d-r2`, D71, D72, D74 | VERY_HIGH |
