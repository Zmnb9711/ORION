...
| D75 | 2026-09-03 | Informational semantic validation | Normal informational responses remain freely and naturally AI-formulated; Core owns `SemanticResponse`, authoritative facts, availability, provenance and freshness, and validates final-response semantic conformance to the allowed Core meaning without treating arbitrary RU/EN grammar or punctuation as the primary safety mechanism; protected operational wording remains Core-owned | User | Explicit | C1-HR01 structural-only safety failure and direct user decision | Non-default semantic-validation candidate over HR01/IA-1/Core binding | APPROVED / CURRENT | Structural-only safety; grammar-primary natural-response validation; AI fact authority | User task, `AG-20260903-215347-b2405b74-d5af18e-r2`, D71, D72, D74 | VERY_HIGH |
