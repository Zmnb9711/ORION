    ...
    def record_conversation_slice(self, event: str, *, realtime_session_id: str, **fields: object) -> None:
        ...
        with self._lock:
            ...
            scalar = {"turn_id", "tx_id", "route", "route_source", "source_sha256", "provider_response_id",
                ...
                "rpc_origin", "rpc_details", "rejected_message_bytes", "grpc_receive_limit", "grpc_send_limit",
                "text_sha256", "text_chars", "text_utf8_bytes", "request_message_bytes", "message_index",
                "message_bytes", "pcm_chunk_bytes", "provider_message_count", "largest_message_bytes", "cleanup_complete",
                "safe_error_code", "producer_done", "pcm_buffer_high_water",
