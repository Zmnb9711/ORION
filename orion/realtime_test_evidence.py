...
_ALLOWED_FIELDS = {
    ...
    "trailing_silence_ms",
    "turn_id",
    "active_orion_turn_id",
    "boundary_source",
    "confirmation_timeout_ms",
    "datagram_bytes",
    "eou_triggered_by_7082",
    "is_encrypted",
    "is_sending",
    ...
    "srs_packet_turn_id",
    "srs_tx_ended_timestamp",
    "srs_tx_sending_on",
    "srs_tx_started_timestamp",
    "srs_tx_state_authoritative",
    "stale_after_ms",
    ...
    "dns_resolve_ms",
    "dns_started_at",
    "first_body_to_complete_ms",
    "headers_to_first_body_ms",
    "latest_tts_phase",
    "pcm_duration_ms",
    "pcm_validated_at",
