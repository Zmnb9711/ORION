...
class OrionSettings(BaseModel):
    ...
    # Callsign is intentionally absent: ORION receives it from DCS.
    ...
    # Original .miz files are never modified.
...
class OrionSettingsUpdate(BaseModel):
    ...
    audio_output_id: str | None = Field(default=None, min_length=1, max_length=300)
